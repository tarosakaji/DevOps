...
#In order to add the repository
...
apt-get update
#Nueva linea agregada para que funcione el java
apt-get install -y openjdk-8-jre openjdk-8-jre-headless openjdk-8-jdk dos2unix zip unzip
